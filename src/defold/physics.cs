...
public static class Physics
{
	...
	public static extern void Create_joint(double joint_type_p1, string collisionobject_a_p2, string joint_id_p3,
		Vector3 position_a_p4, string collisionobject_b_p5, Vector3 position_b_p6);
	...
	/// </summary>
	public static extern void Create_joint(double joint_type_p1, string collisionobject_a_p2, string joint_id_p3,
		Vector3 position_a_p4, Hash collisionobject_b_p5, Vector3 position_b_p6);
	...
	/// </summary>
	public static extern void Create_joint(double joint_type_p1, string collisionobject_a_p2, string joint_id_p3,
		Vector3 position_a_p4, Url collisionobject_b_p5, Vector3 position_b_p6);
