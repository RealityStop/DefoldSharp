...
namespace types
{
	...
	public class Matrix4 : ILuaType
	{
		...
		/// </summary>
		public static extern Matrix4 From_frustum(float left, float right, float bottom, float top, float near,
			float far);
		...
		/// </summary>
		public static extern Matrix4 From_orthographic(float left, float right, float bottom, float top, float near,
			float far);
