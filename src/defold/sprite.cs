...
public class Sprite : BuiltInComponentBase
{
	...
	/// </summary>
	public static extern void play_flipbook(string url_p1, Hash id_p2, Action<object,Hash,LuaTable,Url> complete_function_p3);
	...
	/// @CSharpLua.Template = "sprite.play_flipbook({0}, {1}, {2})"
	/// </summary>
	public static extern void play_flipbook(Hash url_p1, Hash id_p2, Action<object,Hash,LuaTable,Url> complete_function_p3);
	...
	/// @CSharpLua.Template = "sprite.play_flipbook({0}, {1}, {2})"
	/// </summary>
	public static extern void play_flipbook(Url url_p1, Hash id_p2, Action<object,Hash,LuaTable,Url> complete_function_p3);
