...
public static class Tilemap
{
	...
	///     To clear a tile, set the tile to number 0. Which tile map and layer to manipulate is identified by the URL and the
	///     layer name parameters.
	///     Transform bitmask is arithmetic sum of one or both FLIP constants (<code>tilemap.H_FLIP</code>,
	///     <code>tilemap.V_FLIP</code>) and/or one of ROTATION constants
