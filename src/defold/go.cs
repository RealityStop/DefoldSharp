...
public static class Go
{
	...
	/// <summary>
	///     The position is relative the parent (if any). Use <a href="/ref/go#go.get_world_position">go.get_world_position</a>
	...
	/// <summary>
	///     The rotation is relative to the parent (if any). Use
	///     <a href="/ref/go#go.get_world_rotation">go.get_world_rotation</a> to retrieve the global world rotation.
	...
	/// <summary>
	///     The scale is relative the parent (if any). Use <a href="/ref/go#go.get_world_scale">go.get_world_scale</a> to
	///     retrieve the global world 3D scale factor.
	...
	/// <summary>
	///     The uniform scale is relative the parent (if any). If the underlying scale vector is non-uniform the min element of
	///     the vector is returned as the uniform scale factor.
	...
	/// <summary>
	///     Sets the parent for a game object instance. This means that the instance will exist in the geometrical space of its
	///     parent,
	///     like a basic transformation hierarchy or scene graph. If no parent is specified, the instance will be detached from
	///     any parent and exist in world
	///     space.
	///     This function will generate a <code>set_parent</code> message. It is not until the message has been processed that
	///     the change actually takes effect. This
	///     typically happens later in the same frame or the beginning of the next frame. Refer to the manual to learn how
	...
	///     For most cases it should be fine to use <a href="/ref/go#go.get_world_scale_uniform">go.get_world_scale_uniform</a>
	///     instead.
	...
	///     Use <a href="/ref/go#go.get_scale_uniform">go.get_scale_uniform</a> to retrieve the scale factor relative to the
	///     parent.
	...
	///     <ul>
	///         <li>
	///             If <code>path</code> is specified, it can either be absolute or relative to the instance of the calling
	///             script.
	///         </li>
	///         <li>
	///             If <code>path</code> is not specified, the id of the game object instance the script is attached to will be
	///             returned.
	///         </li>
	///     </ul>
	...
	/// <summary>
	///     By calling this function, all or specified stored property animations of the game object or component will be
	///     canceled.
	///     See the <a href="/manuals/properties">properties guide</a> for which properties can be animated and the
	///     <a href="/manuals/animation">animation guide</a> for how to animate them.
	...
	///     <span class="icon-attention"></span> Deleting a game object containing a particle FX component emitting particles
	///     will not immediately stop the particle FX from emitting particles. You need to manually stop the particle FX using
	///     <code>particlefx.stop()</code>.
	///     <span class="icon-attention"></span> Deleting a game object containing a sound component that is playing will not
	///     immediately stop the sound from playing. You need to manually stop the sound using <code>sound.stop()</code>.
	...
	///     The properties defined this way are automatically exposed in the editor in game objects and collections which use
	///     the script.
	...
	///     The <code>message</code> parameter is a table containing the message data. If the message is sent from the engine,
	///     the
	...
	///                 </td>
	///                 <td>
	///                     The amount of input given by the user. This is usually 1 for buttons and 0-1 for analogue inputs.
	...
	///                 </td>
	///                 <td>
	///                     If the input was repeated this frame. This is similar to how a key on a keyboard is repeated when
	///                     you hold it down. This is not present for mouse movement.
	///                 </td>
	///             </tr>
	///             <tr>
	///                 <td>
