...
public static class Factory
{
	...
	/// <summary>
	///     This decreases the reference count for each resource loaded with factory.load. If reference is zero, the resource
	///     is destroyed.
	...
	/// <summary>
	///     Resources are referenced by the factory component until the existing (parent) collection is destroyed or
	///     factory.unload is called.
	///     Calling this function when the factory is not marked as dynamic loading does nothing.
	...
	///     If the game object is created inside of the frame (e.g. from an update callback), the game object will be created
	///     instantly, but none of its component will be updated in the same frame.
	///     Properties defined in scripts in the created game object can be overridden through the properties-parameter below.
	///     See go.property for more information on script properties.
	///     <span class="icon-attention"></span> Calling <a href="/ref/factory#factory.create">factory.create</a> on a factory
	///     that is marked as dynamic without having loaded resources
	///     using <a href="/ref/factory#factory.load">factory.load</a> will synchronously load and create resources which may
