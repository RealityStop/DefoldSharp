...
public static class Gui
{
	...
	/// <summary>
	///     If an animation of the specified node is currently running (started by <code>gui.animate</code>), it will
	...
	/// </summary>
	public static extern void Play_flipbook(Node node_p1, string animation_p2,
		Action<object, Node> complete_function_p3);
	...
	/// <summary>
	///     If node is set as visible clipping node, it will be shown as well as clipping. Otherwise, it will only clip but not
	///     show visually.
	...
	/// <summary>
	///     If node is set as an visible clipping node, it will be shown as well as clipping. Otherwise, it will only clip but
	///     not show visually.
	...
	///     the device.
	///     This function is only available on iOS and Android. <span class="icon-ios"></span>
	...
	/// <summary>
	///     This is only useful nodes with flipbook animations. Sets the playback rate of the flipbook animation on a node.
	///     Must be positive.
	...
	///     or release user input focus (see <code>release_input_focus</code>). There is no use in starting any animations or
	///     similar
	...
	///     It can be used to take action on the message, e.g. update the gui or send a response back to the sender of the
	///     message.
	...
	/// <summary>
	///     This is a callback-function, which is called by the engine when user input is sent to the instance of the gui
	///     component.
