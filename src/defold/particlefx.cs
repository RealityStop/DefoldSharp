...
public static class Particlefx
{
	...
	///     <span class="icon-attention"></span> A particle FX will continue to emit particles even if the game object the
	///     particle FX component belonged to is deleted. You can call <code>particlefx.stop()</code> to stop it from emitting
	///     more particles.
