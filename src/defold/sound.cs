...
public static class Sound
{
	...
	///     <span class="icon-macos"></span><span class="icon-windows"></span><span class="icon-linux"></span>
	///     <span class="icon-html5"></span> On non mobile platforms,
	///     this function always return <code>false</code>.
	///     <span class="icon-attention"></span><span class="icon-android"></span> On Android you can only get a correct
	///     reading
	...
	/// <summary>
	///     Make the sound component play its sound. Multiple voices are supported. The limit is set to 32 voices per sound
	///     component.
	///     <span class="icon-attention"></span> Note that gain is in linear scale, between 0 and 1.
	///     To get the dB value from the gain, use the formula <code>20 * log(gain)</code>.
	///     Inversely, to find the linear value from a dB value, use the formula
	///     <code>10<sup>db/20</sup></code>.
	///     <span class="icon-attention"></span> A sound will continue to play even if the game object the sound component
	///     belonged to is deleted. You can call <code>sound.stop()</code> to stop the sound.
