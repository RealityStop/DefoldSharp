...
{
	/// <summary>
	///     Constant buffers are used to set shader program variables and are optionally passed to the
	///     <code>render.draw()</code> function.
	///     The buffer's constant elements can be indexed like an ordinary Lua table, but you can't iterate over them with
	///     pairs() or ipairs().
	...
	/// <summary>
	///     Clear buffers in the currently enabled render target with specified value. If the render target has been created
	///     with multiple
	...
	///     <a href="/ref/go#go.set">go.set</a> (or
	///     <a href="/ref/particlefx#particlefx.set_constant">particlefx.set_constant</a>) on visual components.
	...
	///     The color specified by setting the blendcolor is referred to as (R<sub>c</sub>,G<sub>c</sub>,B<sub>c</sub>,A
	///     <sub>c</sub>).
	...
	///     The color values have integer values between 0 and (k<sub>R</sub>,k<sub>G</sub>,k<sub>B</sub>,k<sub>A</sub>), where
	///     k<sub>c</sub> = 2<sup>m<sub>c</sub></sup> - 1 and m<sub>c</sub> is the number of bitplanes for that color. I.e for
	///     8 bit color depth, color values are between <code>0</code> and <code>255</code>.
	...
	///                 </td>
	///                 <td>
	///                     (R<sub>s</sub>/k<sub>R</sub>,G<sub>s</sub>/k<sub>G</sub>,B<sub>s</sub>/k<sub>B</sub>,A<sub>s</sub>
	///                     /k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	...
	///                 </td>
	///                 <td>
	///                     (1,1,1,1) - (R<sub>s</sub>/k<sub>R</sub>,G<sub>s</sub>/k<sub>G</sub>,B<sub>s</sub>/k<sub>B</sub>,A
	///                     <sub>s</sub>/k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	///                 <td>
	...
	///                 </td>
	///                 <td>
	///                     (R<sub>d</sub>/k<sub>R</sub>,G<sub>d</sub>/k<sub>G</sub>,B<sub>d</sub>/k<sub>B</sub>,A<sub>d</sub>
	///                     /k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	...
	///                 </td>
	///                 <td>
	///                     (1,1,1,1) - (R<sub>d</sub>/k<sub>R</sub>,G<sub>d</sub>/k<sub>G</sub>,B<sub>d</sub>/k<sub>B</sub>,A
	///                     <sub>d</sub>/k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	///                 <td>
	...
	///                 </td>
	///                 <td>
	///                     (A<sub>s</sub>/k<sub>A</sub>,A<sub>s</sub>/k<sub>A</sub>,A<sub>s</sub>/k<sub>A</sub>,A<sub>s</sub>
	///                     /k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	...
	///                 </td>
	///                 <td>
	///                     (1,1,1,1) - (A<sub>s</sub>/k<sub>A</sub>,A<sub>s</sub>/k<sub>A</sub>,A<sub>s</sub>/k<sub>A</sub>,A
	///                     <sub>s</sub>/k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	...
	///                 </td>
	///                 <td>
	///                     (A<sub>d</sub>/k<sub>A</sub>,A<sub>d</sub>/k<sub>A</sub>,A<sub>d</sub>/k<sub>A</sub>,A<sub>d</sub>
	///                     /k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	...
	///                 </td>
	///                 <td>
	///                     (1,1,1,1) - (A<sub>d</sub>/k<sub>A</sub>,A<sub>d</sub>/k<sub>A</sub>,A<sub>d</sub>/k<sub>A</sub>,A
	///                     <sub>d</sub>/k<sub>A</sub>)
	///                 </td>
	///             </tr>
	///             <tr>
	...
	/// <summary>
	///     Specifies whether the individual color components in the frame buffer is enabled for writing (<code>true</code>) or
	///     disabled (<code>false</code>). For example, if <code>blue</code> is <code>false</code>, nothing is written to the
	///     blue component of any pixel in any of the color buffers, regardless of the drawing operation attempted. Note that
	///     writing are either enabled or disabled for entire color components, not the individual bits of a component.
	...
	///         <li>
	///             <code>render.COMPARE_FUNC_LEQUAL</code> (passes if the incoming depth value is less than or equal to the
	///             stored value)
	///         </li>
	///         <li>
	///             <code>render.COMPARE_FUNC_GREATER</code> (passes if the incoming depth value is greater than the stored
	///             value)
	///         </li>
	///         <li>
	///             <code>render.COMPARE_FUNC_GEQUAL</code> (passes if the incoming depth value is greater than or equal to the
	///             stored value)
	///         </li>
	///         <li><code>render.COMPARE_FUNC_EQUAL</code> (passes if the incoming depth value is equal to the stored value)</li>
	///         <li>
	///             <code>render.COMPARE_FUNC_NOTEQUAL</code> (passes if the incoming depth value is not equal to the stored
	///             value)
	///         </li>
	...
	///         <li>
	///             <code>render.STENCIL_OP_REPLACE</code> (sets the stencil buffer value to <code>ref</code>, as specified by
	///             <a href="/ref/render#render.set_stencil_func">render.set_stencil_func</a>)
	///         </li>
	///         <li>
	///             <code>render.STENCIL_OP_INCR</code> (increments the stencil buffer value and clamp to the maximum
	///             representable unsigned value)
	///         </li>
	///         <li>
	///             <code>render.STENCIL_OP_INCR_WRAP</code> (increments the stencil buffer value and wrap to zero when
	...
	///         <li>
	///             <code>render.STENCIL_OP_DECR_WRAP</code> (decrements the current stencil buffer value and wrap to the
	///             maximum representable unsigned value when decrementing zero)
	///         </li>
	...
	///     The value of the offset is computed as <code>factor</code> &times; <code>DZ</code> + <code>r</code> &times;
	///     <code>units</code>
