...
public static class Http
{
	...
	/// </summary>
	public static extern void request(string url_p1, string method_p2, Action<> callback_p3, ILuaTable headers_p4);
	...
	/// </summary>
	public static extern void request(string url_p1, string method_p2, Action<> callback_p3, ILuaTable headers_p4, string post_data_p5);
	...
	/// </summary>
	public static extern void request(string url_p1, string method_p2, Action<> callback_p3, ILuaTable headers_p4, string post_data_p5, ILuaTable options_p6);
