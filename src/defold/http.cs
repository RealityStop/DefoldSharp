...
public static class Http
{
	...
	///     <span class="icon-attention"></span> If no timeout value is passed, the configuration value "network.http_timeout"
	///     is used. If that is not set, the timeout value is <code>0</code> (which blocks indefinitely).
